...
package body ada_main is
   ...
   E139 : Short_Integer; pragma Import (Ada, E139, "p_heroe_E");
   E163 : Short_Integer; pragma Import (Ada, E163, "p_persona_E");
   E165 : Short_Integer; pragma Import (Ada, E165, "p_triangulo_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "p_triangulo__finalize_spec");
      begin
         F1;
      end;
      E163 := E163 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "p_persona__finalize_spec");
      begin
         F2;
      end;
      E139 := E139 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "p_heroe__finalize_spec");
      begin
         F3;
      end;
      E157 := E157 - 1;
   ...
   begin
      ...
      P_Persona'Elab_Body;
      E163 := E163 + 1;
      P_Triangulo'Elab_Spec;
      P_Triangulo'Elab_Body;
      E165 := E165 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   --   C:\GNAT\2021\CursoADA\09.Objetos\obj\p_heroe.o
   --   C:\GNAT\2021\CursoADA\09.Objetos\obj\p_persona.o
   --   C:\GNAT\2021\CursoADA\09.Objetos\obj\p_triangulo.o
   --   C:\GNAT\2021\CursoADA\09.Objetos\obj\main.o
   --   -LC:\GNAT\2021\CursoADA\09.Objetos\obj\
   --   -LC:\GNAT\2021\CursoADA\09.Objetos\obj\
